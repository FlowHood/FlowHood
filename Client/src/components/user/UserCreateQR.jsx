    ...
    <div className="flex flex-col items-center justify-start p-4 text-black sm:gap-20 md:gap-10 lg:gap-12">
      <div className="flex w-full flex-col items-center justify-center lg:flex-row lg:justify-around lg:gap-10">
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <GeneralButton textDescription={"Generar llave QR"} action={generateQR} />
        </div>
        <div className="flex flex-col items-center justify-center gap-8 mt-10 lg:mt-0">
          <h2 className="text-[2rem] text-center font-semibold">Solicitudes de entrada disponibles</h2>
          <VisitorRequestInfo />
        </div>
      </div>
    </div>
